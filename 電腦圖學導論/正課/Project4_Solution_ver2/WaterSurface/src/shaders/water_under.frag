...
void main() {
    ...
    vec3 reflectedColor = getSurfaceRayColor(f_in.position, reflectedRay, underwaterColor);
    vec3 refractedColor = getSurfaceRayColor(f_in.position, refractedRay, vec3(1.0)) * vec3(0.8, 1.0, 1.1);
