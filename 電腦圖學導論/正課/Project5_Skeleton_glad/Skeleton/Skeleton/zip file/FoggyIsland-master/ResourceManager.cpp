...
Texture2D& ResourceManager::LoadTexture(const GLchar *file, GLboolean alpha, std::string name, GLboolean gammaCorrection)
{
...
Texture2D ResourceManager::loadTextureFromFile(const GLchar *file, GLboolean alpha, GLboolean gammaCorrection)
{
